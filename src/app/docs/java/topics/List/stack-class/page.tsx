...
export default function JavaStackClass(): JSX.Element {
  ...
  return (
    <div className="editor-contents text-black">
      ...
      <p className="mb-4">
         The Java collections framework has a class named <code>Stack</code>.
      </p>

      <p className="mb-4">
         The <code>Stack</code> class provides the functionality of the stack data structure.
      </p>

      <p className="mb-4">
         The <code>Stack</code> class extends the <code>Vector</code> class.
      </p>
...
[Image of Working of stack data structure]
      ...
      <p className="mb-4">
         To create a stack, we must first import the <code>java.util.Stack</code> package.
      </p>
      ...
      <p className="mb-4">
         Here, <code>Type</code> indicates the stack's type. For example:
      </p>
...
Stack<String> stacks = new Stack<>();`}</code>
      ...
      <p className="mb-4">
         Since <code>Stack</code> extends the <code>Vector</code> class, it inherits all the methods of <code>Vector</code>.
      </p>

      <p className="mb-4">
         Additionally, the <code>Stack</code> class includes 5 more methods that distinguish it from <code>Vector</code>.
      </p>
      ...
      <p className="mb-4">
         To add an element to the top of the stack, we use the <code>push()</code> method. For example:
      </p>
...
class Main {
    public static void main(String[] args) {
      ...
      <p className="mb-4">
         To remove an element from the top of the stack, we use the <code>pop()</code> method. For example:
      </p>
...
Removed Element: Cat`}</code>
      ...
      <p className="mb-4">
         The <code>peek()</code> method returns the object from the top of the stack without removing it. For example:
      </p>
...
Element at top: Cat`}</code>
      ...
      <p className="mb-4">
         The <code>search()</code> method returns the position of the element from the top of the stack.
      </p>
...
Position of Horse: 2`}</code>
      ...
      <p className="mb-4">
         The <code>empty()</code> method checks whether a stack is empty or not and returns a boolean result. For example:
      </p>
...
Is the stack empty? false`}</code>
      ...
      <p className="mb-4">
         The <code>Stack</code> class provides a direct implementation of the stack data structure.
      </p>

      <p className="mb-4">
         However, it is generally recommended to use the <code>ArrayDeque</code> class (which implements the <code>Deque</code> interface) to implement the stack data structure in Java due to efficiency reasons.
      </p>
