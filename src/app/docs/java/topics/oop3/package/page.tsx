...
export default function JavaPackagePage() {
  return (
    <div className="editor-contents text-black">
      ...
      <pre className="bg-gray-200 p-4 rounded-lg overflow-auto">{`java.sql.ResultSet // belongs to java.sql package
import java.sql.*;    // importing the entire package`}</pre>
      ...
      <pre className="bg-gray-200 p-4 rounded-lg overflow-auto">{`java.util.Date
java.sql.Date`}</pre>
      ...
      <pre className="bg-gray-200 p-4 rounded-lg overflow-auto">{`import java.util.ArrayList;
...
class ArrayListUtilization {
    public static void main(String[] args) {
      ...
      <pre className="bg-gray-200 p-4 rounded-lg overflow-auto">{`[3, 2, 1]`}</pre>
      ...
      <pre className="bg-gray-200 p-4 rounded-lg overflow-auto">{`package packageName;`}</pre>

      <p>Folder structure example:</p>
      <pre className="bg-gray-200 p-4 rounded-lg overflow-auto">{`com/
  test/
    Test.java`}</pre>

      <pre className="bg-gray-200 p-4 rounded-lg overflow-auto">{`package com.test;
...
class Test {
  ...
  company/
    name/`}</pre>
      ...
      <pre className="bg-gray-200 p-4 rounded-lg overflow-auto">{`import package.name.ClassName; // import specific class
import package.name.*;        // import entire package`}</pre>

      <pre className="bg-gray-200 p-4 rounded-lg overflow-auto">{`class MyClass extends java.util.Date {
    // body
}`}</pre>
      ...
      <pre className="bg-gray-200 p-4 rounded-lg overflow-auto">{`package com.programiz;
...
public class Helper {
    public static String getFormattedDollar(double value) {
      ...
      <pre className="bg-gray-200 p-4 rounded-lg overflow-auto">{`import com.programiz.Helper;
