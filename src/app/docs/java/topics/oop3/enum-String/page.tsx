...
class Main {
   public static void main(String[] args) {
      ...
      <pre className="bg-gray-200 p-4 rounded-lg overflow-auto">{`string value of SMALL is SMALL
...
class Main {
   public static void main(String[] args) {
      ...
      <h3 className="text-xl font-semibold mt-4 text-black">Output</h3>
      <pre className="bg-gray-200 p-4 rounded-lg overflow-auto">{`The size is medium.`}</pre>
